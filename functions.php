<?php 
	...
	function register_my_menus() {
		register_nav_menus(array(
			'top-menu' => __('Top Menu', 'mike-blog'),
			'main-menu' => __('Main Menu', 'mike-blog')
		));
	}
	...
	if (function_exists('register_sidebar')) {
		register_sidebar(
			array(
				'name' => __('Main Sidebar', 'mike-blog'),
				'id' => 'main-sidebar',
				'description' => __('The main sidebar area', 'mike-blog'),
		...
		register_sidebar(
			array(
				'name' => __('Left Footer', 'mike-blog'),
				'id' => 'left-footer',
				'description' => __('The left footer area', 'mike-blog'),
		...
		if (get_comment_type() == 'pingback' || get_comment_type() == 'trackback') : ?>
			...
			<li class="pingback" id="comment-<?php comment_ID(); ?>">
				<article <?php comment_class(); ?>>
					<header>
						<h5><?php _e('pingback', 'mike-blog'); ?></h5>
			...
			<li id='comment-<?php comment_ID(); ?>'>
				<article <?php comment_class('clearfix'); ?>>
					...
					<?php if($comment->comment_approved == '0') : ?>
						...
						<p class="awaiting-moderation"><?php _e('Your comment is awaiting moderation.', 'mike-blog'); ?></p>
					<?php endif; ?>
